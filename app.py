...
def mostrar_tela_inicial():
    ...
    <div style='background-color: white; padding: 20px; border-radius: 10px; margin-bottom: 10px; text-align: center;'>         
        ...
        <p style='color: #1b4d28; font-weight: bold; font-size: 1.2em;'>Você está prestes a entrar na jornada de proteção dos ninhos das tartaruguinhas da Amazônia.</p>
        <p style='color: #1b4d28; font-weight: bold; font-size: 1.2em;'>Escolha uma opção ao lado e ajude a proteger a vida de cada tartaruguinha.</p>
    </div>
    """, unsafe_allow_html=True)
